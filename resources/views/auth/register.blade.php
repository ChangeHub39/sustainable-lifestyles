    ...
    <div class="container">
        <div class="padding">
            <div class="register" >
                ...
                @if(count($errors) > 0)
                    <div class="alert alert-danger alert-dismissable">There is a mistake in the information you have
...
{{--                    <label for="tools" class="control-label">Incentives - Select as many as you want. Hold control to--}}
...
{{--                    <label for="metronumber" class="control-label">Metrocard Number ---}}
{{--                        <small><em>Leave blank if a new card is required.</em></small>--}}
{{--                    </label>--}}
